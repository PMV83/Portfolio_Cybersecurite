...
Cette section contient l'intégralité du code et des configurations de mon infrastructure Homelab orientée Blue Team.
* **Architecture Zero Trust** : Segmentation réseau sous pfSense et accès sécurisés via Cloudflare.
* **Détection SIEM** : Centralisation des événements sur Splunk Enterprise et tuning des alertes.
* **Analyse Réseau** : Déploiement du moteur Suricata en mode détection puis en mode prévention active.
* **Automatisation** : Utilisation d'Ansible pour configurer et durcir les serveurs de manière standardisée.

### 2. Projets Académiques : ESGI
Cette section regroupe les projets majeurs réalisés durant mon cursus universitaire.
* **Simulation Phishing et IA** : Développement d'une plateforme d'ingénierie sociale assistée par intelligence artificielle.
...
* **CV Interactif** : https://portfolio.pmvix.com